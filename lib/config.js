...
const page = {
    page_param  : 'page', //默认分页标识
    page_size   : 15, //默认分页大小
    page_length : 5, //默认分页长度，0只显示上下页
    ...
    // 分页样式
    pageStyle   : '<ul class="page">${index}${prev}${list}${next}${end}</ul>${info}'
}

module.exports = {app: {...app, ...cfg.app}, db: {...db, ...cfg.db}, page: {...page, ...cfg.page}, route: cfg.route};