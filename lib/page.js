...
class Page extends Ctx {
    ...
    prev() {
        ...
        return this._parse('linkPrev', {page: this._page - 1, url: `?page=${this._page - 1}`});
    }
    ...
    next() {
        ...
        return this._parse('linkNext', {page: this._page + 1, url: `?page=${this._page + 1}`});
    }
    ...
    index() {
        ...
        return this._parse('linkIndex', {page: 1, url: `?page=1`});
    }
    ...
    // 末页
        ...
        return this._parse('linkEnd', {page: this._pageTotal, url: `?page=${this._pageTotal}`});
    }
