...
class Index extends Controller {
    ...
    async mysql() {
        ...
        const [list2, list3, list4] = await Promise.all([
            ...
            this.ctx.$ii.app.model.article.db.find(),
            this.ctx.$ii.app.model.article.db.page(2, 3).select()
        ]);
        //const list2 = model_article.db.find();
        //const list3 = this.ctx.$ii.app.model.article.db.find();
        //const list4 = this.ctx.$ii.app.model.article.db.page(2, 3).select();
